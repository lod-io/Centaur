...
export const questionBank: QuestionBankEntry[] = [
  {
    id: "1",
    content: "What is the primary purpose of CourseHero?",
    answer: "To offer study materials and help from expert tutors",
    choices: ["To provide a platform for online shopping", "To offer study materials and help from expert tutors", "To facilitate social networking among students", "To provide job search services"]
  },
  {
    id: "2",
    content: "Which of the following universities has the most documents available on CourseHero?",
    answer: "Liberty University",
    choices: ["Liberty University", "Grand Canyon University", "Ashford University", "Chamberlain College of Nursing"]
  },
  {
    id: "3",
    content: "How many documents are available for Liberty University on CourseHero?",
    answer: "782K Documents",
    choices: ["500K Documents", "782K Documents", "714K Documents", "642K Documents"]
  },
  {
    id: "4",
    content: "What is one of the key features of CourseHero that helps students succeed?",
    answer: "Study documents shared by students from specific schools and courses",
    choices: ["Access to online games", "Study documents shared by students from specific schools and courses", "Free trial memberships for streaming services", "Discounted textbooks"]
  },
  {
    id: "5",
    content: "Which of the following is NOT a feature provided by CourseHero?",
    answer: "Online shopping discounts",
    choices: ["Step-by-step explanations", "Recommendations", "Help from expert tutors", "Online shopping discounts"]
  },
  {
    id: "6",
    content: "How can students get help on CourseHero?",
    answer: "From expert tutors, 24/7",
    choices: ["Through online forums only", "From expert tutors, 24/7", "By contacting customer support via email", "By attending in-person tutoring sessions"]
  },
  {
    id: "7",
    content: "What type of documents can students discover on CourseHero?",
    answer: "Study documents recently uploaded by other students",
    choices: ["Only textbooks", "Only research papers", "Study documents recently uploaded by other students", "Only lecture notes"]
  },
  {
    id: "8",
    content: "Which of the following schools has the fewest questions available on CourseHero?",
    answer: "Ashford University",
    choices: ["Liberty University", "Grand Canyon University", "Ashford University", "Chamberlain College of Nursing"]
  },
  {
    id: "9",
    content: "What is the purpose of exploring questions recently asked by students and solved by verified experts on CourseHero?",
    answer: "To get help with academic questions",
    choices: ["To find entertainment content", "To get help with academic questions", "To join online communities", "To purchase educational software"]
  },
  {
    id: "10",
    content: "How does CourseHero help students find relevant study materials?",
    answer: "By providing materials for specific courses at their school",
    choices: ["By recommending movies and TV shows", "By providing materials for specific courses at their school", "By offering free trials for streaming services", "By selling educational gadgets"]
  },
  {
    id: "11",
    content: "What types of study materials can users access on CourseHero?",
    answer: "Guides, class notes, videos, and literature guides for different subjects",
    choices: ["Only textbooks and research papers", "Guides, class notes, videos, and literature guides for different subjects", "Only lecture slides and assessments", "Only online games and quizzes"]
  },
  {
    id: "12",
    content: "How can users contribute to CourseHero and earn benefits?",
    answer: "By uploading their own study documents to the library",
    choices: ["By participating in online forums", "By uploading their own study documents to the library", "By attending webinars", "By purchasing additional tools"]
  },
  {
    id: "13",
    content: "What is the cost of the Monthly Plan on CourseHero?",
    answer: "$39.95/month",
    choices: ["$19.95/month", "$39.95/month", "$9.95/month", "$59.85/month"]
  },
  {
    id: "14",
    content: "What is included in the Premier Membership of CourseHero?",
    answer: "Access to up to 30 documents, all Textbook Solutions, and up to 40 tutor questions",
    choices: ["Access to only 10 documents and 10 tutor questions", "Access to up to 30 documents, all Textbook Solutions, and up to 40 tutor questions", "Access to only online tutors at an a la carte price", "Free access to all study materials without any limits"]
  },
  {
    id: "15",
    content: "Can users access CourseHero on mobile devices?",
    answer: "Yes, through Android and iOS mobile applications",
    choices: ["No, it is only available on desktop", "Yes, through Android and iOS mobile applications", "Only through Android mobile applications", "Only through iOS mobile applications"]
  },
  {
    id: "16",
    content: "What is a notable limitation of CourseHero mentioned by users?",
    answer: "The inability to collaborate remotely on projects within the platform",
    choices: ["The lack of online tutors", "The inability to collaborate remotely on projects within the platform", "The limited availability of study materials", "The absence of a free trial"]
  },
  {
    id: "17",
    content: "How does the Annual Plan of CourseHero compare to the Monthly Plan in terms of cost?",
    answer: "The Annual Plan is less expensive than the Monthly Plan",
    choices: ["The Annual Plan is more expensive than the Monthly Plan", "The Annual Plan is the same cost as the Monthly Plan", "The Annual Plan is less expensive than the Monthly Plan", "The Annual Plan includes fewer features than the Monthly Plan"]
  },
  {
    id: "18",
    content: "Can free members on CourseHero seek help from online tutors?",
    answer: "Yes, but at an a la carte price",
    choices: ["No, only Premier members can seek help from online tutors", "Yes, but at an a la carte price", "Yes, with unlimited questions", "No, free members have no access to tutors"]
  },
  {
    id: "19",
    content: "What is the primary benefit of using CourseHero according to user reviews?",
    answer: "Access to a wide range of study materials and expert tutors",
    choices: ["Improved user interface and navigation", "Access to a wide range of study materials and expert tutors", "Integration with existing business processes", "Free trials for all membership plans"]
  },
  {
    id: "20",
    content: "How does CourseHero handle subscription renewals?",
    answer: "Subscriptions renew automatically at the end of the commitment period",
    choices: ["Subscriptions do not renew automatically", "Subscriptions renew automatically at the end of the commitment period", "Users must manually renew their subscriptions each month", "Subscriptions are only available for a one-time payment"]
  }
];
